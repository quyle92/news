<?php
if ($_POST) {
	var_dump ($Ten=$_POST['Ten']);
	$Ten_KD=$_POST['Ten_KhongDau'];
	$ThuTu=$_POST['ThuTu'];
	$AnHien=$_POST['AnHien'];
	$lang=$_POST['lang'];
	$idTL=$_POST['idTL'];
	$qt->LoaiTin_Them ($Ten,$Ten_KD,$ThuTu,$AnHien,$idTL,$lang);//$idTL đề cuối thì hàm sẽ ko chạy
                            ...
                            <form class="form-horizontal" method="post" action="">
                                <div class="row clearfix">
                                   ...
                                   <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" id="Ten" name="Ten" class="form-control" placeholder="Nhập tên loại tin" minlength="3" maxlength= "20" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" placeholder="Tên không dấu"id="Ten_KhongDau" name="Ten_KhongDau" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
								   <div class="row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" placeholder="Thứ tự"id="ThuTu" name="ThuTu" min="1" max="1000" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
